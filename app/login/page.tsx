  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#1a1008]">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-80 p-8 bg-[#2a1f10] rounded-xl">
        ...
        <button className="bg-amber-600 hover:bg-amber-500 text-white py-2 rounded font-semibold">Login</button>
        <a href="/register" className="text-amber-400 text-sm text-center">No account? Register</a>
      </form>
    </div>
  );
}
