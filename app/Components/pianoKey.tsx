...
export default function PianoKey({
  note, label, keyHint, isBlack, isActive, width, height, onNoteOn, onNoteOff,
}: PianoKeyProps) {
  if (isBlack) {
    return (
      <div
        ...
        style={{ width: width ?? 26, height: height ?? 100, touchAction: "none" }}
      >
        {keyHint && (
          <span style={{
  ...
  return (
    <div
      ...
      style={{ width: width ?? 42, height: height ?? 160, touchAction: "none" }}
    >
      <div style={{
        ...
        <span style={{ fontSize: 9, color: isActive ? "#fff" : "#aaa", fontWeight: 600 }}>
          {label}
        </span>
      </div>
    </div>
